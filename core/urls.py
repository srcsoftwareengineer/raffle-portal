...
urlpatterns = [
    ...
    path("sign-in/", auth_views.LoginView.as_view(template_name="registration/sign_in.html"), name="sign_in"),
    ...
    path("raffles/<int:raffle_id>/publish/", raffles.publish_raffle, name="publish_raffle"),
